...
class Cell:
    ...
    def __sub__(self, other):
        ...
        if result > 0:
            ...
            print('Invalid cell subtraction')
        return None
    ...
    @staticmethod
    def make_order(cell, row_len):
        row_height = cell.size // row_len
        row_rem = cell.size % row_len
        row = '*' * row_len + '\n'
        return row * row_height + ('*' * row_rem)


CellInstance = Cell(17)
print(Cell.make_order(CellInstance, 5), '\n')

CellInstance = Cell(17) + Cell(20)
print(Cell.make_order(CellInstance, 10), '\n')

CellInstance = Cell(17) / Cell(3)
print(Cell.make_order(CellInstance, 5), '\n')

CellInstance = Cell(10) * Cell(3)
print(Cell.make_order(CellInstance, 10), '\n')
